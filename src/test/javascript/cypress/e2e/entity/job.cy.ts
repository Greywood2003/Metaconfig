...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('Senior Infrastructure Facilitator');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'Senior Infrastructure Facilitator');

      cy.get(`[data-cy="minSalary"]`).type('14053');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '14053');

      cy.get(`[data-cy="maxSalary"]`).type('21485');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '21485');
