...
describe('Task e2e test', () => {
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="title"]`).type('elderly');
      cy.get(`[data-cy="title"]`).should('have.value', 'elderly');

      cy.get(`[data-cy="description"]`).type('in-joke');
      cy.get(`[data-cy="description"]`).should('have.value', 'in-joke');
