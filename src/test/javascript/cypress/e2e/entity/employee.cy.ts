...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="firstName"]`).type('Samanta');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Samanta');

      cy.get(`[data-cy="lastName"]`).type('Effertz');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Effertz');

      cy.get(`[data-cy="email"]`).type('Scarlett.Terry@hotmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Scarlett.Terry@hotmail.com');

      cy.get(`[data-cy="phoneNumber"]`).type('blah');
      cy.get(`[data-cy="phoneNumber"]`).should('have.value', 'blah');

      cy.get(`[data-cy="hireDate"]`).type('2025-05-22T21:23');
      cy.get(`[data-cy="hireDate"]`).blur();
      cy.get(`[data-cy="hireDate"]`).should('have.value', '2025-05-22T21:23');

      cy.get(`[data-cy="salary"]`).type('5657');
      cy.get(`[data-cy="salary"]`).should('have.value', '5657');

      cy.get(`[data-cy="commissionPct"]`).type('24819');
      cy.get(`[data-cy="commissionPct"]`).should('have.value', '24819');
