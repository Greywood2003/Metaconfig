...
describe('Department e2e test', () => {
  ...
  const departmentSample = { departmentName: 'concerning' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="departmentName"]`).type('entomb jot');
      cy.get(`[data-cy="departmentName"]`).should('have.value', 'entomb jot');
