  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="metaconfigApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="metaconfigApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('metaconfigApp.employee.firstName')}
              ...
              <ValidatedField
                label={translate('metaconfigApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('metaconfigApp.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              />
              <ValidatedField
                label={translate('metaconfigApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('metaconfigApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('metaconfigApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('metaconfigApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('metaconfigApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('metaconfigApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
